...
var (
	severityMap = map[hlog.Level]raven.Severity{
		hlog.TraceLevel: raven.DEBUG,
		hlog.DebugLevel: raven.DEBUG,
		hlog.InfoLevel:  raven.INFO,
		hlog.WarnLevel:  raven.WARNING,
		hlog.ErrorLevel: raven.ERROR,
		hlog.FatalLevel: raven.FATAL,
		hlog.PanicLevel: raven.FATAL,
	}
)
...
type SentryHook struct {
	...
	errorHandlers []func(entry *hlog.Entry, err error)
...
func NewSentryHook(DSN string, levels []hlog.Level) (*SentryHook, error) {
...
// 100 milliseconds.
func NewWithTagsSentryHook(DSN string, tags map[string]string, levels []hlog.Level) (*SentryHook, error) {
...
// This method sets the timeout to 100 milliseconds.
func NewWithClientSentryHook(client *raven.Client, levels []hlog.Level) (*SentryHook, error) {
	return &SentryHook{
		Timeout: 100 * time.Millisecond,
		StacktraceConfiguration: StackTraceConfiguration{
			Enable:            false,
			Level:             hlog.ErrorLevel,
			Skip:              6,
			Context:           0,
			InAppPrefixes:     nil,
...
// mode.
func NewAsyncSentryHook(DSN string, levels []hlog.Level) (*SentryHook, error) {
...
func NewAsyncWithTagsSentryHook(DSN string, tags map[string]string, levels []hlog.Level) (*SentryHook, error) {
...
func NewAsyncWithClientSentryHook(client *raven.Client, levels []hlog.Level) (*SentryHook, error) {
...
func (hook *SentryHook) Fire(entry *hlog.Entry) error {
...
func (hook *SentryHook) Levels() []hlog.Level {
	return hook.levels
}
...
func (hook *SentryHook) AddErrorHandler(fn func(entry *hlog.Entry, err error)) {
